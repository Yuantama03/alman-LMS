            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h4>Tambah Video — {{ $section->judul }}</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('guru.video.store', $section->id) }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <small class="text-muted">Support: youtube.com/watch?v=... atau youtu.be/...</small>
                            </div>
