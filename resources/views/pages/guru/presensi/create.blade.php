                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h4>Input Presensi Kelas {{ $kelas->nama_kelas }}</h4>
                            <a href="{{ route('guru.presensi.index') }}" class="btn btn-primary">Kembali</a>
                        </div>
                        <div class="card-body">
                            <!-- Date Filter -->
                            <form method="GET" action="{{ route('guru.presensi.create') }}" class="mb-4">
                                <div class="row">
                                    <div class="col-md-12">
                            ...
                            <div class="alert alert-warning">
                                <i class="fas fa-exclamation-triangle"></i> Tidak ada siswa di kelas Anda.
                            </div>
                            @endif
                        </div>
                    </div>
